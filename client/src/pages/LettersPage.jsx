...
function LetterTypeIcon({ type, locked }) {
  ...
  if (type === 'draw') {
    return (
      <svg className="letter-icon-svg" viewBox="0 0 24 24" aria-hidden="true">
        <path d="m13.2 13.9 5.4-5.4a2 2 0 0 0-2.8-2.8l-5.4 5.4" />
        <path d="m14.8 6.7 2.8 2.8" />
        <path d="M10.4 11.1c-1.8.2-3.2 1.2-3.8 2.8-.5 1.3-.3 2.7-1.5 4.1 2.2.1 4.4-.1 5.8-1.4 1.1-1 1.5-2.6 1.1-4.1" />
        <path d="M6.9 17.4c1.1-.1 2.1-.4 2.8-1.1" />
      </svg>
    );
  }
